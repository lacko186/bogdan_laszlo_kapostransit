...
if ($stmt->rowCount() > 0) {
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo '<div class="card-image" style="
            width: 100%;
        ...
        $image_url = isset($kepek_by_id[$row["id"]]) ? 
            $kepek_by_id[$row["id"]] : 
            'https://icons.veryicon.com/png/o/business/classic-icon/bus-20.png';
        ...
        // Tartalom konténer fix padding-gel
        echo '<div class="card-details" style="
            padding: 20px;
            flex: 1;
            display: flex;
            flex-direction: column;">';
        
        echo '<h2 class="text-title" style="
            margin: 0 0 10px 0;
            font-size: 1.3em;
            color: #1a1a1a;
            font-weight: 600;
        ...
        echo '<p class="card-details" style="
            margin: 0;
            color: #666;
            line-height: 1.5;">' . 
            htmlspecialchars(substr($row["details"], 0, 100)) . '...</p>';
        
        // Gomb konténer az alján fix padding-gel
        echo '<div style="
            padding: 20px;
            margin-top: auto;
            text-align: center;">';
            
        echo '<a href="hirek.php?id=' . $row["id"] . '" class="card-button" style="
            display: inline-block;
            padding: 12px 24px;
            background: #e63946;
            color: white;
            ...
            width: 100%;
            box-sizing: border-box;"
            onmouseover="this.style.background=\'#d62b38\'"
            onmouseout="this.style.background=\'#e63946\'">
            Részletek
        </a>';
        
        echo '</div>'; // Gomb konténer vége
        echo '</div>'; // Card-details vége
        echo '</div>'; // Card vége
    }
    echo '</div>';
} else {
