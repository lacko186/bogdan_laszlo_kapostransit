...
h3 {
    font-size: clamp(1.2rem, 2vw + 0.6rem, 1.75rem);
    line-height: 1.4;
}
...
.container {
    min-width: var(--min-width);
    max-width: 1920px;
    margin: clamp(60px, 10vh, 100px) auto clamp(20px, 3vh, 40px);
    padding: clamp(10px, 2vw, 30px);
}

/* Grid és Flex konténerek */
.grid {
    display: grid;
...
#map {
    ...
    min-width: clamp(600px, 70vw, 1200px);
...
.text-xl {
    font-size: clamp(1.3rem, 1.5vw + 0.6rem, 1.5rem);
}

.text-2xl {
    font-size: clamp(1.5rem, 2vw + 0.7rem, 1.8rem);
}

/* Reszponzív margók és padding */
.m-responsive {
...
/* Szöveg olvashatóság biztosítása */
